...
public class TransactionService {
    ...
    @Value("${app.transaction.timeout-hours:24}")
        ...
        try {
            ...
            for (Transaction transaction : transactions) {
                ...
                if (!transactionRepository.existsByFingerprint(transaction.getFingerprint())) {
                    ...
                    log.info("[fetchFromEmail] Duplicate transaction ignored: {}", transaction.getFingerprint());
                }
            }
     ...
     */
    @Transactional
    public VerifyTransactionResponse verifyTransaction(Long transactionId, BigDecimal expectedAmount, String orderCode) {
    ...
    public ConfirmPaymentResponse confirmPayment(Long transactionId, Long orderId, 
        ...
        if (transaction.getPaymentDetails() == null || 
            !transaction.getPaymentDetails().toUpperCase().contains(expectedTransferContent.toUpperCase())) {
