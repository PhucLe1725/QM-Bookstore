...
const AdminOrders = () => {
  ...
  const quickFilters = [
    ...
    { label: 'Đã nhận hàng', filter: { fulfillmentStatus: 'picked_up' } },
          ...
          <div className="flex flex-wrap gap-2">
            {quickFilters.map((qf, index) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filters.paymentStatus === (qf.filter.paymentStatus || '') &&
